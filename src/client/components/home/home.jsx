...
export class Home extends Component {
  ...
  onQualifiesChange($event) {
    let form = this.state.form;
    console.log('Qualfies: ', $event.target.checked);
    this.setState({
                ...
                return (
                  <button
                    className={getButtonClass(
                      division.Key === this.state.form.division,
                    )}
                    onClick={(e) => this.onDivisionChange(division.Key)}
                    key={index}
                  >
                    {division.Label}
                  </button>
              ...
              {ROLES.map((role, index) => {
                return (
                  <button
                    ...
                    onClick={(e) => this.onRoleChange(role.Key)}
                    key={index}
                  >
                    {role.Label}
                  </button>
